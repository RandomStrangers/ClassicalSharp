...
namespace Launcher {
	...
	public static class Json {
        ...
        public static bool NextConstant(JsonContext ctx, string value) {
        ...
        public static int NextToken(JsonContext ctx) {
        ...
        public static object ParseValue(int token, JsonContext ctx) {
			switch (token) {
        ...
        public static JsonObject ParseObject(JsonContext ctx) {
        ...
        public static JsonArray ParseArray(JsonContext ctx) {
        ...
        public static string ParseString(JsonContext ctx) {
        ...
        public static string ParseNumber(JsonContext ctx) {
			int start = ctx.Idx - 1;
