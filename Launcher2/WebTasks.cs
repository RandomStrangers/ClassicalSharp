...
namespace Launcher.Web {
	...
	public abstract class WebTask {
        ...
        public static JsonObject ParseJson(Request req) {
	...
	public sealed class SignInTask : WebTask {	
        ...
        public static string GetLoginError(JsonObject obj) {
			...
			return "Log in using the ClassiCube Client! You might need a login code!";
		}
	}
